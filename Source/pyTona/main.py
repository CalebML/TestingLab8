...
from pyTona.answer_funcs import feet_to_miles, hal_20, get_git_branch, get_git_url, get_other_users, get_fibonacci_seq, get_hdd_access_time, get_prime_num, get_pi_num, get_2pct_interest_10_yrs
...
class Interface(object):
    def __init__(self):
        ...
        self.question_answers = {
            ...
            'What is the number of pi': QA('What is the number of pi', get_pi_num),
            'How much money will i have if i invest dollars at 2% for ten years': QA('How much money will i have if i invest dollars at 2% for ten years', get_2pct_interest_10_yrs)
